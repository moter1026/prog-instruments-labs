...
def download_and_process_data(stock_name) -> tuple[Any, Any, Any]:
...
def split_data(close_data, df) -> tuple[Any, Any, Any, Any]:
...
def sequence_to_supervised(look_back, close_train, close_test) -> tuple[Any, Any]:
...
def train_model(look_back, train_generator, epochs) -> Any:
...
def plot_train_test_graph(stock, model, test_generator,
                          ...
                          date_train, date_test) -> tuple[Figure, float]:
...
def predict(num_prediction, model, close_data, look_back) -> Any:
...
def predict_dates(num_prediction, df) -> list:
...
def predicting(close_data, model, look_back, df) -> tuple[Any, Any, list]:
...
def plot_future_prediction(model, test_generator, close_train,
                           close_test, df, forecast_dates, forecast) -> Figure:
    prediction = model.predict_generator(test_generator)
...
def update_graph(value) -> (tuple[dict, dict, str, str] |
                            tuple[Figure, Figure, str, Any]):
    try:
        stock = value
